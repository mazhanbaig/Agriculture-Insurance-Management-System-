...
export async function createLandParcel(farmerId: string, data: {
...
export async function updateLandParcel(parcelId: string, farmerId: string, data: Record<string, any>) {
